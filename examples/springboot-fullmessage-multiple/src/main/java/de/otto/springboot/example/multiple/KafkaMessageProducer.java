...
public class KafkaMessageProducer {
  ...
  private final String topicTwoName;
  ...
  @Scheduled(fixedDelay = 7, initialDelay = 10, timeUnit = TimeUnit.SECONDS)
  public void onTickTopicTwo() {
    String data =
        "{\"data\":\"Some TopicTwo my data at " + LocalTime.now()
            .format(DateTimeFormatter.ISO_LOCAL_TIME)
            + ".\"}";
    publishKafkaMessage(topicTwoName, data);
  }
